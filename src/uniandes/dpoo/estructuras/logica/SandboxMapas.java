...
public class SandboxMapas
{
    ...
    {
        List<String> llaveMayusculas = new ArrayList<String>();
        for ( String llave: mapaCadenas.keySet())
        {
        	llaveMayusculas.add(llave.toUpperCase());
        }
        return llaveMayusculas;
    }
    ...
    public void volverMayusculas( )
    {
    	...
    	for (Map.Entry<String, String> pareja: mapaCadenas.entrySet())
    	{
    		...
    		nuevoMapa.put(llaveMayuscula, pareja.getValue());
    	}
