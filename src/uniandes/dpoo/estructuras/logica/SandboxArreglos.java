...
public class SandboxArreglos
{
    ...
    public HashMap<Integer, Integer> calcularHistograma( )
    {
        ...
        for (int i = 0; i < arregloEnteros.length; i++)
        {
        	...
        	{
        		int vecesAnteriores = histograma.get(valor);
        		histograma.put(valor, vecesAnteriores +1);
        	}
        	else
        	{
    ...
    public int contarEnterosRepetidos( )
    {
    	...
    	{
    		int veces = histograma.get(valor);
    		if (veces > 1)
    		{
    			contador++;
    		}
    ...
    public boolean mismosEnteros( int[] otroArreglo )
    {
        ...
        for (int i = 0; i < copiaOtro.length; i++)
        {
        	for (int j= 0; j < copiaOtro.length - 1; j++)
        	{
